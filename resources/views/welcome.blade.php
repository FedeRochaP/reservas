...
<head>
    ...
    <link rel="icon" href="{{ asset('images/tu_favicon.ico') }}" type="image/x-icon">
...
<body class="antialiased">
    ...
    <div
        ...
        <div class="home__logo">
            <h2>Sistema de reservas web</h2>
            <img src="{{ asset('images/logo.png') }}" alt="Logo">
            <br>
            <h3>Por favor, registrate o inicia sesion para realizar una reserva</h3>
        </div>
    </div>
</body>
